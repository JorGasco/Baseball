...
class PlayersAPITest {
    ...
    inner class UpdatePlayers {
        ...
        fun `updating a note that does not exist returns false`(){
            assertFalse(populatedPlayers!!.updatePlayer(6, Players("Updating player", "Gasco", 12, 1.80, 50.00, "infield", false)))
            assertFalse(populatedPlayers!!.updatePlayer(-1, Players("Updating player", "Gasco", 12, 1.80, 50.00, "infield", false)))
            assertFalse(emptyPlayers!!.updatePlayer(0, Players("Updating player", "Gasco", 12, 1.80, 50.00, "infield", false)))
        }
        ...
        fun `updating a note that exists returns true and updates`() {
            ...
            assertTrue(populatedPlayers!!.updatePlayer(4, Players("Updating player", "Gasco", 12, 1.80, 50.00, "infield", false)))
